...
export class Backend implements backendInterface {
    ...
    async getAllSubmissions(): Promise<Array<HireSubmission>> {
        if (this.processError) {
            try {
    ...
    async getFreelancerApplications(): Promise<Array<FreelancerApplication>> {
        if (this.processError) {
            try {
                const result = await this.actor.getFreelancerApplications();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitFreelancerApplication(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string, arg6: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitFreelancerApplication(arg0, arg1, arg2, arg3, arg4, arg5, arg6);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitHireForm(arg0: string, arg1: string, arg2: string, arg3: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.submitHireForm(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
